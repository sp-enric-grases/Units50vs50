...
[CustomEditor(typeof(SkinnedMeshCrowdGenerator))]
public class DrawSkinnedMeshCrowdGenerator : Editor
{
    void OnSceneGUI()
    {
        SkinnedMeshCrowdGenerator crowdGenerator = (SkinnedMeshCrowdGenerator)target;

        if (crowdGenerator.crowdShapeType == SkinnedMeshCrowdGenerator.CrowdShapeType.Rectangle)
        {
            SkinnedMeshCrowdGenerator.RectangleArea rectangleArea = crowdGenerator.generateInCuboidArea;
        ...
        {
            Handles.color = Color.green;
            SkinnedMeshCrowdGenerator.CycleArea cycleArea = crowdGenerator.generateCycleArea;
    ...
    public override void OnInspectorGUI()
    {
        ...
        else if (crowdGenerator.crowdShapeType == SkinnedMeshCrowdGenerator.CrowdShapeType.Cycle)
        {
