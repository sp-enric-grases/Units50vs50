...
#ifndef GPU_ANIMATIN_BAKER_PRO_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
#define GPU_ANIMATIN_BAKER_PRO_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
...
VertexOutputBaseSimple vertForwardBaseSimple (SkinVertexInput v)
{
    ...
    UNITY_INITIALIZE_VERTEX_OUTPUT_STEREO(o);
		...
		VertexMotion3(v.vertex,v.normal,v.tangent,v);
	#else
		VertexMotion2(v.vertex,v.normal,v);
	#endif
...
VertexOutputForwardAddSimple vertForwardAddSimple (SkinVertexInput v)
{
...
#endif // GPU_ANIMATIN_BAKER_PRO_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
