...
#ifndef GPU_ANIMATIN_BAKER_PRO_STANDARD_CORE_INCLUDED
#define GPU_ANIMATIN_BAKER_PRO_STANDARD_CORE_INCLUDED
...
VertexOutputForwardBase vertForwardBase (SkinVertexInput v)
{
...
VertexOutputForwardAdd vertForwardAdd (SkinVertexInput v)
{
    UNITY_SETUP_INSTANCE_ID(v);
...
VertexOutputDeferred vertDeferred (SkinVertexInput v)
{
    UNITY_SETUP_INSTANCE_ID(v);
...
#endif // GPU_ANIMATIN_BAKER_PRO_STANDARD_CORE_INCLUDED
