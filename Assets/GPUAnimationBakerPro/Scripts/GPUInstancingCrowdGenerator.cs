...
/// </summary>
public class GPUInstancingCrowdGenerator : MonoBehaviour
{
    [System.Serializable]
    ...
    void Start()
    {
        if (animatePrefab.GetComponent<Renderer>().sharedMaterial.enableInstancing == false)
        {
            animatePrefab.GetComponent<Renderer>().sharedMaterial.enableInstancing = true;
        }
